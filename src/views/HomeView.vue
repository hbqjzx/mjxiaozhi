<template>
  <div class="main">
    <h3>
      <p>Midjourney Imagine API 调用网站</p>
      <p>
        Midjourney
    ...
    <h3>
      ...
      <a
        href="https://auth.zhishuyun.com/auth/login?inviter_id=b01a5684-a3e4-43d6-a7c1-61105ccf9a8c&redirect=https://data.zhishuyun.com"
    ...
    <a-textarea
      ...
      placeholder="图像描述：在第一次生成预览图时，需要指定该字段，代表待生成图像的描述。建议用英文，可调用GPT翻译或使用第三方平台翻译。"
      :rows="4"
    />
    <a-radio-group
